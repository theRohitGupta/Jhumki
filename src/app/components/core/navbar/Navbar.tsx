...
const Navbar: React.FC = () => {
  const infoBarContents: {
    ...
    {
      key: "1",
      content: "<h1>7 Days Free and Easy Returns/COD Available</h1>",
    },
    { key: "2", content: <SaleEndsIn endDate="2024-03-06T23:59:59" /> },
    {
      key: "3",
      content:
        "<h1>Flat 300/- Off on Orders Above 2000. Use Code JUMKEY300</h1>",
    },
    ...
    {
      key: "6",
      content: "<h1>Times Honoured Best Fashion Jewellery Brand</h1>",
    },
  ];
